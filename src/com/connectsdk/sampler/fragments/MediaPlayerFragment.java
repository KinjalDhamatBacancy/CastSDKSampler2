...
//    public CheckBox subtitlesButton;
    ...
    public RadioGroup urlRadioGroup;
...
//        subtitlesButton = (CheckBox) rootView.findViewById(R.id.subtitlesButton);
        ...
        urlRadioGroup = (RadioGroup) rootView.findViewById(R.id.radioGroup);
...
//                subtitlesButton,
        ...
        urlRadioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                switch (checkedId) {
                    case R.id.rbUrl1:
                        URL_VIDEO_MP4 = "http://d1fb1b55vzzqwl.cloudfront.net/en-us/torahclass/video/ot/genesis/video-genesis-l07-ch6-ch7.mp4";
                        break;
                    case R.id.rbUrl2:
                        URL_VIDEO_MP4 = "http://d1fb1b55vzzqwl.cloudfront.net/en-us/torahclass/video/ot/esther/video-esther-l05-ch3-ch4.mp4";
                        break;
                    case R.id.rbUrl3:
                        URL_VIDEO_MP4 = "http://d1fb1b55vzzqwl.cloudfront.net/en-us/torahclass/video/ot/daniel/video-daniel-l01-intro.mp4";
                        break;
                    case R.id.rbUrl4:

                        URL_VIDEO_MP4 = "http://d1fb1b55vzzqwl.cloudfront.net/en-us/torahclass/video/ot/ruth/video-ruth-l08-ch4.mp4";
                        break;
                }
            }
        });
...
//            Toast.makeText(getActivity(), "video has capable", Toast.LENGTH_SHORT).show();
...
//            Toast.makeText(getActivity(), "video has not capable", Toast.LENGTH_SHORT).show();
...
//        Toast.makeText(getActivity(), "video click", Toast.LENGTH_SHORT).show();
        Toast.makeText(getActivity(), URL_VIDEO_MP4, Toast.LENGTH_SHORT).show();
//        boolean shouldLoop = loopingButton.isChecked();
...
//                .setSubtitleInfo(subtitleBuilder == null ? null : subtitleBuilder.build())
        ...
        getMediaPlayer().playMedia(mediaInfo, false, new MediaPlayer.LaunchListener() {

            @Override
            public void onError(ServiceCommandError error) {
                Log.e("Error", "Error playing video", error);
                Toast.makeText(getActivity(), "video cast error " + error, Toast.LENGTH_SHORT).show();

                stopMediaSession();
            }

            public void onSuccess(MediaLaunchObject object) {
                Toast.makeText(getActivity(), "video cast success " + object, Toast.LENGTH_SHORT).show();
